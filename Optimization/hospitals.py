...
class Space():
    ...
    def __init__(self, height, width, num_hospitals):
        """Create a new state space width given dimensions."""
        self.height = height
        self.width = width
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        for i in range(self.num_hospitals):
            self.hospitals.add(random.choice(list(self.avaliable_spaces())))
        if log:
    ...
    def random_restart(self, maximum, image_prefix=None, log=False):
        ...
        # Repeat hill_climbing a fixed number of times
    ...
    # Use local to deretmine hospital placement
